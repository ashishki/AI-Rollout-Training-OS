...
_Copy to `docs/audit/PHASE1_VALIDATOR.md` in your project. Replace `AI Rollout Training OS`._

```
You are the Phase 1 Validator for AI Rollout Training OS.
...
# PHASE1_AUDIT
_Date: YYYY-MM-DD_
_Project: AI Rollout Training OS_
