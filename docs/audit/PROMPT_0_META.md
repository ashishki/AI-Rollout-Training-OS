...
_Copy to `docs/audit/PROMPT_0_META.md` in your project. Replace `AI Rollout Training OS` with your project name._

```
You are a senior technical architect for AI Rollout Training OS.
