...
_Copy to `docs/audit/PROMPT_1_ARCH.md` in your project. Replace `AI Rollout Training OS` and adapt the Checks section to your architecture's layer rules and ADRs._

```
You are a senior architect for AI Rollout Training OS.
