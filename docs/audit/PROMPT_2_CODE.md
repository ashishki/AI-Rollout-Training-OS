...
_Copy to `docs/audit/PROMPT_2_CODE.md` in your project. Replace `AI Rollout Training OS` and adapt the Checklist section to your project's security requirements._

```
You are a senior security engineer for AI Rollout Training OS.
