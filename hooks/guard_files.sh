#!/usr/bin/env bash
# Write guard helper: guard_files.sh
# Blocks runtime writes to immutable playbook files.
#
# Intended for host environments that can pass JSON tool input before writes.
#
# Configuration:
...
#   2  Block the write; stderr explains the reason
